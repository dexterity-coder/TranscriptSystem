                    ...
                    <div class="inner-block">
                        <div class="typo-badges">
                            <div class="appearance">
                                <h3 class="ghj">All Transcript Application</h3>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            $sn = 0;
                                            $get_rec = mysqli_query($conn, "select * from application");
                                            while ($row = mysqli_fetch_array($get_rec)) {
                                                ...
                                                <tr>
                                                    ...
                                                    if ($app_status == "0" && $appfee=="") {
                                                        ?>
                                                    <td><b>Pending Processing fee Payment</b></td>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <td><a class="btn btn-primary" href="details?i=<?php echo base64_encode($appid); ?>">Details</a></td>
                                                        <?php
                                                    }
                                                    ?>
                                                </tr>
